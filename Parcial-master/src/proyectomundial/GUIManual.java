...
public class GUIManual extends JFrame {
    ...
    private  void Iniciarsesion(Container seleccionesPanel){  
        JButton Iniciar_sesion= new JButton();
        Iniciar_sesion.setLayout(new BoxLayout(seleccionesPanel, BoxLayout.Y_AXIS));
        Iniciar_sesion.setPreferredSize((new java.awt.Dimension(800, 20)));
        Iniciar_sesion.setMaximumSize( jPanelRight.getPreferredSize());
        Iniciar_sesion.setText("Iniciar Sesion");
        jPanelMain.add(Iniciar_sesion);
    }
