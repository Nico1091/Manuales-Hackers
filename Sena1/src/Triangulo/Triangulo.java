...
public class Triangulo {
    ...
    public  void Tipo_de_Triangulo(){
      ...
      public void impresiones(){
          ...
          lado1=(double)(lado2*lado2)+(lado3*lado3)-(2*lado1*lado2)*Math.cos(lado1);
          lado2=(double)(lado1*lado1)+(lado3*lado3)-(2*lado1*lado3)*Math.cos(lado2);
          lado3=(double)(lado2*lado2)+(lado1*lado1)-(2*lado1*lado1)*Math.cos(lado3);          
